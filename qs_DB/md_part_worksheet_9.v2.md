16. 如图8，在$\triangleABC$中， $\angle A C B = 90 ^ { \circ }$ , $\angle B - \angle A = 10 ^ { \circ }$ , $D$ 是 $A B$ 上一个动点，连接CD，将$\triangleACD$沿CD翻折后得到$\triangleCED$，边CE交AB于点F.若$\triangleDEF$是直角三角形，则$\angle A C D =$ 2520
